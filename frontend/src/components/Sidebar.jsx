...
import defaultAvatar from "../assets/avatar.png"; // Import the default avatar image
...
const Sidebar = () => {
  ...
  // Ensure users and onlineUsers are always arrays
          ...
          filteredUsers.map((user) => (
            ...
            >
              ...
              <div className="relative mx-auto lg:mx-0">
                <img
                  src={user.profilePic || defaultAvatar} // Use default avatar if profilePic is missing
                  alt={user.name}
